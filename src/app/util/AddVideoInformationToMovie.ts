...
import { MovieDetails, MovieDetailsImpl } from '../Entities/moviedetails/MovieDetails';
...
export class AddVideoInformationToMovies {
   ...
   static addVideoInfoToMovie(service: MovieApiServiceService,movie:Movie): MovieDetails {
